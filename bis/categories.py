...
CATEGORY_TABLE: dict[str, tuple[str, CategoryType]] = {
    ...
    # python-tooling
    "uv": ("python-tooling", "tooling"),
    "ruff": ("python-tooling", "tooling"),
    "ty": ("python-tooling", "tooling"),
    "mypy": ("python-tooling", "tooling"),
    "black": ("python-tooling", "tooling"),
    "pytest": ("python-tooling", "tooling"),
    "ipykernel": ("python-tooling", "tooling"),
    # python-terminal
